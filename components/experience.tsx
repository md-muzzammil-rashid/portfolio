  ...
  const experiences = [
    {
      ...
      company: "Codingal Inc. (YC W21)",
      location: "Bengaluru, Karnataka",
      period: "October 2025 – Present",
      achievements: [
        "Single-threaded owner of the end-to-end notifications system, managing WhatsApp, email, SMS, and Slack alerts for students, teachers, and internal teams at scale",
        "Built and maintained 20+ Celery-scheduled automation workflows, eliminating repetitive Teacher-Ops and Growth tasks and significantly improving operational efficiency",
        "Developed ETL pipelines powering teacher-performance, trial-conversion, and churn analytics dashboards used by internal business teams",
        "Contributed extensively to Blackops, the internal operations platform, by shipping features like Free Trial Teacher Finder, teacher-mapping anomaly detection, continent-aware eligibility rules, and the complete slot-management suite",
        "Engineered AI-powered classroom tools including Smart Class Prep Brief, Ice Breaker, and Student Encouragement using an in-house LLM abstraction layer built on OpenAI and Anthropic models",
        "Integrated and optimized scalable backend services with Celery, Redis, and Django, improving task processing reliability and reducing operational bottlenecks across critical workflows",
      ],
      technologies: [
        "Python",
        "Django",
